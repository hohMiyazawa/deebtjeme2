...
choh: choh.cpp hoh_header.hpp panic.hpp file_io.hpp lode_io.hpp lodepng.cpp entropy_coding.hpp encode.hpp numerics.hpp colour_transform.hpp colour_filters.hpp lz_matchFinder.hpp symbolstats.hpp
	g++ -o $@ $< lodepng.cpp -O2 $(LIBS)
